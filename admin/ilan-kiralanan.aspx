<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ilan-kiralanan.aspx.cs" Inherits="emlak.admin.ilan_kiralanan" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="icerik">
            <asp:UpdatePanel runat="server" ID="update_tablo">
                <ContentTemplate>
                    <div class="blokbaslik">Ana Sayfa » İlanlar » Kiralanan İlanlar</div>
                    <div class="blokicerik">
                        ...
                        <asp:GridView ID="kayitlar" runat="server" Width="100%" CssClass="gridstil" onrowdatabound="kayitlar_RowDataBound" AutoGenerateColumns="false" onrowcommand="kayitlar_RowCommand" DataKeyNames="ID">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="Kod" HeaderText="İlan Kodu" HeaderStyle-HorizontalAlign="Left" ItemStyle-Width="60" />
                                ...
                                <asp:BoundField DataField="Il" HeaderText="İl" HeaderStyle-HorizontalAlign="Left" ItemStyle-Width="90" />
                                <asp:BoundField DataField="Ilce" HeaderText="İlçe" HeaderStyle-HorizontalAlign="Left" ItemStyle-Width="90" />
