<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ayar-genel.aspx.cs" Inherits="emlak.admin.ayar_genel" %>
                ...
                <table>
                    <tbody>
                        <tr>
                            ...
                            <td><strong>:</strong></td>
                            <td>
                                <asp:TextBox ID="form_firma" runat="server" Width="300px"></asp:TextBox><asp:RequiredFieldValidator 
                                    ID="RequiredFieldValidator1" runat="server" ControlToValidate="form_firma" 
                                    Display="None" ErrorMessage="Lütfen firma adını giriniz." 
...
&nbsp;</td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:RequiredFieldValidator 
                                    ID="RequiredFieldValidator4" runat="server" ControlToValidate="form_telefon" 
                                    Display="None" ErrorMessage="Lütfen telefon numaranızı giriniz." 
                                    ValidationGroup="ekle"></asp:RequiredFieldValidator>
                                (örn: 0 242 123 45 67)</td>
                        </tr>
                        <tr>
                            <td><strong>Cep Telefon</strong></td>
                            <td><strong>:</strong></td>
                            <td>
                                <asp:TextBox ID="form_ceptelefon" runat="server" Width="300px"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                                    ControlToValidate="form_ceptelefon" Display="None" 
                                    ErrorMessage="Lütfen cep telefon numarası giriniz." ValidationGroup="ekle"></asp:RequiredFieldValidator>
                        ...
                        <tr>
                            ...
                            <td><strong>:</strong></td>
                            <td>
                                <asp:TextBox ID="form_faks" runat="server" Width="300px"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" 
                                    ControlToValidate="form_faks" Display="None" 
                                    ErrorMessage="Lütfen faks numarası giriniz." ValidationGroup="ekle"></asp:RequiredFieldValidator>
                                (örn: 0 242 123 45 00)</td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" 
                                    ...
                                    ErrorMessage="Lütfen adresinizi giriniz." ValidationGroup="ekle"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
