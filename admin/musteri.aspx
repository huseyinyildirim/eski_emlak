<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="musteri.aspx.cs" Inherits="emlak.admin.musteri" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="icerik">
            <asp:UpdatePanel runat="server" ID="update_tablo">
                <ContentTemplate>
                    <div class="blokbaslik">Ana Sayfa » Müşteri » Müşteriler</div>
                    <div class="blokicerik">
                        ...
                        <asp:GridView ID="kayitlar" runat="server" Width="100%" CssClass="gridstil" onrowdatabound="kayitlar_RowDataBound" AutoGenerateColumns="false" onrowcommand="kayitlar_RowCommand" DataKeyNames="ID">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="Ad" HeaderText="Adı Soyadı" HeaderStyle-HorizontalAlign="Left" ItemStyle-Width="130" />
                                <asp:BoundField DataField="Telefon" HeaderText="Telefon" HeaderStyle-HorizontalAlign="Left" ItemStyle-Width="130" />
                                <asp:BoundField DataField="Adres" HeaderText="Adres" HeaderStyle-HorizontalAlign="Left" />
                                <asp:BoundField DataField="Not" HeaderText="Not" HeaderStyle-HorizontalAlign="Left" />
                        ...
                        <div class="h10"></div>
                        <div class="blokkomut"><asp:Button ID="secilenlerisil" runat="server" Text="Seçilenleri Sil" onclick="secilenlerisil_Click" OnClientClick="return confirm('Seçtiğiniz kayıtları silmek istediğinizden eminmisiniz?');" />&nbsp;<asp:Button ID="yeniekle" runat="server" Text="Yeni Müşteri Ekle" onclick="yeniekle_Click" />
                        </div>
                    </div>
                </ContentTemplate>
                <Triggers>
