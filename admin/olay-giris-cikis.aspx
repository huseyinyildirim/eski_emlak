<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="olay-giris-cikis.aspx.cs" Inherits="emlak.admin.olay_giris_cikis" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="icerik">
            <asp:UpdatePanel runat="server" ID="update_tablo">
                <ContentTemplate>
                    <div class="blokbaslik">Ana Sayfa » Kullanıcı Yönetimi » Giriş-Çıkış Kayıtları</div>
