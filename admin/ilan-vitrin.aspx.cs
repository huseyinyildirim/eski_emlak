...
{
    public partial class ilan_vitrin : System.Web.UI.Page
    {
        ...
        protected void Sayfalama()
        {
            ...
            {
                var SQL = db.tbl_ilan.Where(a => a.vitrin == true && a.onay == true && a.arsiv == false).Count();
        ...
        protected void KayitYukle(string SqlCumle)
        {
            ...
            using (BaglantiCumlesi db = new BaglantiCumlesi())
            {
                var SQL = (from a in db.tbl_ilan
                           where a.vitrin == true && a.onay == true && a.arsiv == false
                           select new
                           {
                               a.id,
                               a.baslik,
