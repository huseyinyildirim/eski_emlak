...
{
    public partial class ilan_satilan : System.Web.UI.Page
    {
        ...
        protected void Sayfalama()
        {
            ...
            {
                var SQL = db.tbl_ilan.Where(a => a.satis == true && a.ilan_tur == "Satılık").Count();
        ...
        protected void KayitYukle(string SqlCumle)
        {
            ...
            using (BaglantiCumlesi db = new BaglantiCumlesi())
            {
                var SQL = (from a in db.tbl_ilan
                           where a.satis == true && a.ilan_tur == "Satılık"
                           select new
                           {
                               a.id,
                               a.baslik,
