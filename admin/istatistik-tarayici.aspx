<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="istatistik-tarayici.aspx.cs" Inherits="emlak.admin.istatistik_tarayici" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="icerik">
            <asp:UpdatePanel runat="server" ID="update_tablo">
                <ContentTemplate>
                    <div class="blokbaslik">Ana Sayfa » İstatistikler » Tarayıcılar</div>
                                ...
                                <tr>
                                    ...
                                    <td valign="top">
                                        ...
                                        <asp:GridView ID="kayitlar" runat="server" Width="100%" CssClass="gridstil" AutoGenerateColumns="false">
                                            ...
                                            <Columns>
                                                <asp:BoundField DataField="IsletimSistemi" HeaderText="Tarayıcılar" HeaderStyle-HorizontalAlign="Left" />
