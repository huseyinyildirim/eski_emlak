<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ilan-satilan.aspx.cs" Inherits="emlak.admin.ilan_satilan" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="icerik">
            <asp:UpdatePanel runat="server" ID="update_tablo">
                <ContentTemplate>
                    <div class="blokbaslik">Ana Sayfa » İlanlar » Satılan İlanlar</div>
