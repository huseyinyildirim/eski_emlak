<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ilan-ozellik-ekle.aspx.cs" Inherits="emlak.admin.ilan_ozellik_ekle" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="icerik">
            <div class="blokbaslik">Ana Sayfa » İlan Özellikleri » İlan Özellikleri » İlan 
                Özellik Ekle</div>
            <div class="blokicerik">
                <table>
                    <tbody>
                        ...
                        <tr>
                            <td><strong>İlan Özellik Adı</strong></td>
                            <td><strong>:</strong></td>
                            <td>
