<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="kategori.aspx.cs" Inherits="emlak.kategori" %>
...
<body>
    ...
    <div class="icdiv beyazilan">
        <h1><asp:Literal runat="server" ID="kategoriadi" /> ilanları</h1>
        <asp:Literal runat="server" ID="datalistbos" />
