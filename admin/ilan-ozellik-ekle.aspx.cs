...
{
    public partial class ilan_ozellik_ekle : System.Web.UI.Page
    {
        ...
        protected void btn_kayitekle_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Class.Fonksiyonlar.JavaScript.MesajKutusuVeYonlendir("İlan özelliği başarıyla eklenmiştir. İlan özellikleri listesine yönlendiriliyorsunuz.", "ilan-ozellik.aspx");
            }
            catch (Exception ex)
            {
                Class.Fonksiyonlar.JavaScript.MesajKutusuVeYonlendir(Yonetim.Degiskenler.Hata + ex.Message, "ilan-ozellik-ekle.aspx");
            }
        }
    }
}