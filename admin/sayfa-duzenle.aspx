<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sayfa-duzenle.aspx.cs" Inherits="emlak.admin.sayfa_duzenle" %>
...
<body>
                        ...
                        <tr>
                            ...
                            <td>
                                <CKEditor:CKEditorControl ID="form_detay" runat="server" Height="200" 
                                    BasePath="~/Yonetim/App/ckeditor" 
                                    ContentsCss="~/Yonetim/App/ckeditor/contents.css" 
                                    TemplatesFiles="~/Yonetim/App/ckeditor/plugins/templates/templates/default.js" EnterMode="BR" ShiftEnterMode="BR"
	...
	FilebrowserFlashUploadUrl="/Yonetim/App/ckfinder/core/connector/aspx/connector.aspx?command=QuickUpload&type=Flash"></CKEditor:CKEditorControl>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="3">&nbsp;</td>
