<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Logo.ascx.cs" Inherits="Include_Ust" %>
    ...
    <div class="icdiv">
        <div class="sol"><a href="/"><img src="/Image/logo.jpg" alt="Emlak Sitesi" /></a></div>
        <div class="sag">
            <ul class="anamenu">
                <li class="ilk"><h3><a href="/">ana sayfa</a></h3></li>
                <asp:Literal runat="server" ID="ustmenusayfa" />
                <li><h3><a href="/Iletisim.aspx">iletişim</a></h3></li>
            </ul>
        </div>
    </div>
    <div class="clear"></div>
    ...
    <div class="arama">
        <table class="style1">
            ...
            <tr>
                ...
                <ContentTemplate>
                <td>
                    <asp:DropDownList ID="form_il" runat="server" Width="150px" AutoPostBack="true" onselectedindexchanged="form_il_SelectedIndexChanged"></asp:DropDownList>
                </td>
                <td>
                    <asp:DropDownList ID="form_ilce" runat="server" Width="150px" AutoPostBack="true" Enabled="false" onselectedindexchanged="form_ilce_SelectedIndexChanged"></asp:DropDownList>
                </td>
                <td>
                    <asp:DropDownList ID="form_semt" runat="server" Width="150px" AutoPostBack="true" Enabled="false"></asp:DropDownList>
                </td>
                </ContentTemplate>
                </asp:UpdatePanel>
            </tr>
