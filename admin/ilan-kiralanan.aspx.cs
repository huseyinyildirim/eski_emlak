...
{
    public partial class ilan_kiralanan : System.Web.UI.Page
    {
        ...
        protected void Sayfalama()
        {
            ...
            {
                var SQL = db.tbl_ilan.Where(a => a.satis == true && a.ilan_tur == "Kiralık").Count();
        ...
        protected void KayitYukle(string SqlCumle)
        {
            ...
            using (BaglantiCumlesi db = new BaglantiCumlesi())
            {
                var SQL = (from a in db.tbl_ilan
                           where a.satis == true && a.ilan_tur == "Kiralık"
                           select new
                           {
                               a.id,
                               a.baslik,
