<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ilan-sabit.aspx.cs" Inherits="emlak.admin.ilan_sabit" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="icerik">
            <asp:UpdatePanel runat="server" ID="update_tablo">
                <ContentTemplate>
                    <div class="blokbaslik">Ana Sayfa » İlan Özellikleri » İlan Sabitleri</div>
                    <div class="blokicerik">
                        ...
                        <asp:GridView ID="kayitlar" runat="server" Width="100%" CssClass="gridstil" onrowdatabound="kayitlar_RowDataBound" AutoGenerateColumns="false" onrowcommand="kayitlar_RowCommand" DataKeyNames="ID">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="Kategori" HeaderText="Kategori" HeaderStyle-HorizontalAlign="Left" ItemStyle-Width="130" />
                                <asp:BoundField DataField="Sabit" HeaderText="İlan Sabitleri" HeaderStyle-HorizontalAlign="Left" />
                                <asp:BoundField DataField="Tip" HeaderText="Sabit Tipi" HeaderStyle-HorizontalAlign="Left" />
                                <asp:BoundField DataField="TipDegisken" HeaderText="Tip Değişkeni" HeaderStyle-HorizontalAlign="Left" />
                        ...
                        <div class="blokkomut"><asp:Button ID="secilenlerisil" runat="server" Text="Seçilenleri Sil" onclick="secilenlerisil_Click" OnClientClick="return confirm('Seçtiğiniz kayıtları silmek istediğinizden eminmisiniz?');" />&nbsp;<asp:Button 
                                ID="yeniekle" runat="server" Text="Yeni İlan Sabiti Ekle" 
