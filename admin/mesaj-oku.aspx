<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mesaj-oku.aspx.cs" Inherits="emlak.admin.mesaj_oku" %>
                ...
                <tbody>
                    <tr>
                        <td valign="top" width="48%">
                            <div class="blokbaslik">Ana Sayfa » Mesaj Kutusu » Mesaj Detayı</div>
                            <div class="blokicerik">
                                <asp:Literal runat="server" ID="mesajdetay" />
                                <br />
                                <br />
                                <asp:Button ID="btn_cevap" runat="server" onclick="btn_cevap_Click" 
                                    Text="Yanıtla" />
&nbsp;<asp:Button ID="btn_alinti_cevap" runat="server" onclick="btn_alinti_cevap_Click" 
                                    Text="Alıntılı Yanıtla" />
                            </div>
                        </td>
                        <td width="1%"></td>
