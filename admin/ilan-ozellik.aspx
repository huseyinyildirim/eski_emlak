<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ilan-ozellik.aspx.cs" Inherits="emlak.admin.ilan_ozellik" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="icerik">
            <asp:UpdatePanel runat="server" ID="update_tablo">
                <ContentTemplate>
                    <div class="blokbaslik">Ana Sayfa » İlan Özellikleri » İlan Özellikleri</div>
                    <div class="blokicerik">
                        <div class="blokkomut">
                            <div style="display:inline; float:left; margin-left:10px;">İlan Özellikleri: 
                        ...
                        <asp:GridView ID="kayitlar" runat="server" Width="100%" CssClass="gridstil" onrowdatabound="kayitlar_RowDataBound" AutoGenerateColumns="false" onrowcommand="kayitlar_RowCommand" DataKeyNames="ID">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HtmlEncode="false" DataField="Baslik" HeaderText="İlan Özellikleri" HeaderStyle-HorizontalAlign="Left" />
                        ...
                        <div class="blokkomut"><asp:Button ID="secilenlerisil" runat="server" Text="Seçilenleri Sil" onclick="secilenlerisil_Click" OnClientClick="return confirm('Seçtiğiniz kayıtları silmek istediğinizden eminmisiniz?');" />&nbsp;<asp:Button 
                                ID="yeniekle" runat="server" Text="Yeni İlan Özellik Ekle" 
            ...
            <div class="h10"></div>
            <div class="blokbaslik"><strong>İlan Özellikleri Kategorisi</strong> Ekle</div>
            <div class="blokicerik">
                <table>
                    <tbody>
                        <tr>
                            <td><strong>İlan Özellikleri Kategori</strong></td>
                            <td><strong>:</strong></td>
