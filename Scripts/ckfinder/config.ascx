...
<script runat="server">
	...
	public override bool CheckAuthentication()
	{
        ...
        if (HttpContext.Current.Request.Cookies["" + Class.Fonksiyonlar.Genel.ParametreAl("guvenlik_kodu") + "Giris"] != null)
        {
            if (HttpContext.Current.Request.Cookies["" + Class.Fonksiyonlar.Genel.ParametreAl("guvenlik_kodu") + "Giris"].Value == "7777777")
            {
                x = true;
            }
            else
