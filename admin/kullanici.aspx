<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="kullanici.aspx.cs" Inherits="emlak.admin.kullanici" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="icerik">
            <asp:UpdatePanel runat="server" ID="update_tablo">
                <ContentTemplate>
                    <div class="blokbaslik">Ana Sayfa » Kullanıcı Yönetimi » Kullanıcılar</div>
                    <div class="blokicerik">
                        ...
                        <asp:GridView ID="kayitlar" runat="server" Width="100%" CssClass="gridstil" onrowdatabound="kayitlar_RowDataBound" AutoGenerateColumns="false" onrowcommand="kayitlar_RowCommand" DataKeyNames="ID">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="Adi" HeaderText="Adı Soyadı" HeaderStyle-HorizontalAlign="Left" SortExpression="ad" HtmlEncode="false" />
                                <asp:BoundField DataField="Eposta" HeaderText="E-posta Adresi" HeaderStyle-HorizontalAlign="Left" SortExpression="eposta" />
                                <asp:BoundField DataField="Telefon" HeaderText="Telefon" HeaderStyle-HorizontalAlign="Left" SortExpression="telefon" />
                                <asp:BoundField DataField="SonGiris" HeaderText="Son Giriş Tarihi" HeaderStyle-HorizontalAlign="Left" ItemStyle-Width="130" />
                        ...
                        <div class="h10"></div>
                        <div class="blokkomut"><asp:Button ID="secilenlerisil" runat="server" Text="Seçilenleri Sil" onclick="secilenlerisil_Click" OnClientClick="return confirm('Seçtiğiniz kayıtları silmek istediğinizden eminmisiniz?');" />&nbsp;<asp:Button ID="yeniekle" runat="server" Text="Yeni Kullanıcı Ekle" onclick="yeniekle_Click" />
                        </div>
                    </div>
                </ContentTemplate>
                <Triggers>
