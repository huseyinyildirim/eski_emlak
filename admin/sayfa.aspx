<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sayfa.aspx.cs" Inherits="emlak.admin.sayfa" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="icerik">
            <asp:UpdatePanel runat="server" ID="update_tablo">
                <ContentTemplate>
                    <div class="blokbaslik">Ana Sayfa » İçerik Yönetimi » Sayfalar</div>
                    <div class="blokicerik">
                        <div class="blokkomut">
                            <div style="display:inline; float:right; margin-left:10px; height: 11px;">Sayfa:<asp:DropDownList 
                                    ID="sayfa2" runat="server" AutoPostBack="true" 
                                    OnSelectedIndexChanged="sayfasec" />
&nbsp;</div>
                        ...
                        <asp:GridView ID="kayitlar" runat="server" Width="100%" CssClass="gridstil" onrowdatabound="kayitlar_RowDataBound" AutoGenerateColumns="false" onrowcommand="kayitlar_RowCommand" DataKeyNames="ID">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HtmlEncode="false" DataField="Baslik" HeaderText="Sayfa Başlık" HeaderStyle-HorizontalAlign="Left" />
                        ...
                        <div class="blokkomut"><asp:Button ID="secilenlerisil" runat="server" Text="Seçilenleri Sil" onclick="secilenlerisil_Click" OnClientClick="return confirm('Seçtiğiniz kayıtları silmek istediğinizden eminmisiniz?');" />&nbsp;<asp:Button 
                                ID="yeniekle" runat="server" Text="Yeni Sayfa Ekle" 
