<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ilan-vitrin.aspx.cs" Inherits="emlak.admin.ilan_vitrin" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="icerik">
            <asp:UpdatePanel runat="server" ID="update_tablo">
                <ContentTemplate>
                    <div class="blokbaslik">Ana Sayfa » İlanlar » Vitrindeki İlanlar</div>
